...
libfastann = ctypes.CDLL('libfastann.so', mode=ctypes.RTLD_GLOBAL)
try:
    libfastcluster = ctypes.CDLL('libfastcluster.so', mode=ctypes.RTLD_GLOBAL)
except OSError, e:
    libfastcluster = ctypes.CDLL('./libfastcluster.so', mode=ctypes.RTLD_GLOBAL)
...
if __name__ == "__main__":
    ...
    if libfastcluster.rank() == 0:
        ...
        pnts_fobj = tables.openi_file('pnts.h5','w')
